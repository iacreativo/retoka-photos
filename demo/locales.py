...
LOCALES = {
    ...
    "print_switch": {
        ...
        "en": {"label": "Paper size", "choices": ["6 inch", "5 inch", "A4", "3R", "4R", "4x3 inch", "4x6 half sheet (6 photos, reuse paper)"]},
        "zh": {"label": "相纸选择", "choices": ["六寸", "五寸", "A4", "3R", "4R", "4x3 寸", "4x6 半页 (6 张,可复用)"]},
        "ja": {"label": "用紙サイズ", "choices": ["6インチ", "5インチ", "A4", "3R", "4R", "4x3 インチ", "4x6 半分 (6枚、再利用可)"]},
        "ko": {"label": "용지 사이즈", "choices": ["6인치", "5인치", "A4", "3R", "4R", "4x3 인치", "4x6 반장 (6장, 재활용)"]},
        "es": {"label": "Tamaño del papel", "choices": ["6 pulgadas (4x6)", "5 pulgadas", "A4", "3R", "4R", "4x3 pulgadas", "4x6 media hoja (6 fotos, reutilizable)"]},
    },
}
