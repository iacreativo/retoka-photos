...
def load_configuration(root_dir):
    ...
    size_list_dict_ES = csv_to_size_list(
        os.path.join(root_dir, "assets/size_list_ES.csv")
    )
    ...
    color_list_dict_ES = csv_to_color_list(
        os.path.join(root_dir, "assets/color_list_ES.csv")
    )
